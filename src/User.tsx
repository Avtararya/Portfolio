...
const socialLinks = [
    { link: "https://github.com/Avtararya", icon: IconBrandGithub },
    { link: "https://www.linkedin.com/in/someshkhade", icon: IconBrandLinkedin },
    { link: "https://www.instagram.com/khadesomesh/", icon: IconBrandInstagram }, 
    { link: "https://www.youtube.com/@Bhikhmangi_Kaum", icon: IconBrandYoutube },
    { link: "https://leetcode.com/u/khadesomesh3/", icon: IconBrandLeetcode }
];
